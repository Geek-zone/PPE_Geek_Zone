...
try {
	...
	$reponse=$bdd->query('SELECT * FROM produit WHERE categorie="3" ');
	$nb=$reponse->rowCount();
	...
	while($donnees = $reponse ->fetch()){
		echo'<tr>';
		echo'<td class="c2"><img src="../img/mode/'.$donnees['image'].'" height="150" width="150" /></td>';
