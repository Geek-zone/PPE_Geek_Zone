...
<div = "ville">
	<div class = "albertville">Chambery</div>
<br/><br/>

<div class = "img_bout">
		<img src = "img/chambery.png" width = "250px" height = "250px">
		<img src = "img/boutiques/boutique_chambery.jpg" width = "250px" height = "250px">		
</div>
...
try {
		...
		$reponse = $bdd -> query('SELECT * FROM boutique where id = 4');
