...
<div = "ville">
	<div class = "albertville">Annecy</div>
<br/><br/>

<div class = "img_bout">
		<img src = "img/annecy.png" width = "250px" height = "250px">
		<img src = "img/boutiques/boutique_annecy.jpg" width = "250px" height = "250px">		
</div>
...
try {
		...
		$reponse = $bdd -> query('SELECT * FROM boutique where id = 6');
