...
<div = "ville">
	<div class = "albertville">Lyon</div>
<br/><br/>

<div class = "img_bout">
		<img src = "img/lyon.png" width = "250px" height = "250px">
		<img src = "img/boutiques/boutique_lyon.jpg" width = "250px" height = "250px">		
</div>
...
try {
		...
		$reponse = $bdd -> query('SELECT * FROM boutique where id = 3');
