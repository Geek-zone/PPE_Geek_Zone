...
<div = "ville">
	<div class = "albertville">Grenoble</div>
<br/><br/>

<div class = "img_bout">
		<img src = "img/grenoble.png" width = "250px" height = "250px">
		<img src = "img/boutiques/boutique_grenoble.jpg" width = "250px" height = "250px">		
</div>
...
try {
		...
		$reponse = $bdd -> query('SELECT * FROM boutique where id = 2');
